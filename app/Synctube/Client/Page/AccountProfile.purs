...
content state@{ profile: Just profile } =
  R.div [ RP.className "col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3" ]
    ...
    , R.div
        [ RP.className "profile-box linewrap"
    ...
    , R.form [ RP.action "/account/profile", RP.method "post", RP.role "form" ]
        ...
        , R.div [ RP.className "form-group" ]
            [ R.label
                [ RP.className "control-label", RP.htmlFor "profileimage" ]
                [ R.text "Image" ]
            , R.input
                [ RP._id "profileimage", RP.className "form-control"
                , RP._type "text", RP.name "image"
                ] []
            ]
        , R.div [ RP.className "form-group" ]
            [ R.label [ RP.className "control-label", RP.htmlFor "profiletext" ]
                [ R.text "Text" ]
            , R.textarea
                [ RP._id "profiletext", RP.className "form-control"
                , RP.cols "10", RP.name "text"
                ]
                [ R.text profile.text ]
            ]
        , R.button
            [ RP.className "btn btn-primary btn-block", RP._type "submit" ]
            [ R.text "Save" ]
        ]
    ]
