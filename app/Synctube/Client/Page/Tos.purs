...
generalRules state =
  ...
  , R.p'  [ R.text $
              ...
              the following rules apply globally and must be observed
              at all times on the site.
              Failure to comply with these rules may result in
              temporary or permanent removal of your user account
              from the website.""" ]
  , R.ul' [ R.li' [ R.text  """Trolling, spamming, or otherwise intentionally
                            disrupting any channel is not allowed""" ]
          , R.li' [ R.text  """Bullying or otherwise intending to hurt
                            other users is not allowed""" ]
          , R.li' [ R.text
                      """Attempting to exploit the site in order to gain
                      unauthorized access or interrupt service is not allowed.
  ...
  R.div [ RP.className "col-md-12" ]
        ...
        , R.ul'
            [ R.li'
                ...
                , R.ul' [ R.li' [ R.text "Child pornography" ]
                        , R.li' [ R.text "Warez" ]
            ...
            , R.li' [ R.text $
                        ...
                        Viewing shared content is done
